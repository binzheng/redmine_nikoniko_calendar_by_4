...
2. git clone https://github.com/binzheng/redmine_nikoniko_calendar_by_4.git
3. mv redmine_nikoniko_calendar_by_4 redmine_nikoniko_calendar2
4. cd /path/to/redmine
5. rake redmine:plugins:migrate NAME=redmine_nikoniko_calendar2
   (create table by manual use createTable.sql)
6. restart redmine
